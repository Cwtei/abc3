...
void Fahrzeug::vSimulieren()
{
	...
	p_dGefahreneStrecke = p_pVerhalten->dStrecke(*this, dT); //this is the pointer to the current Fahrzeug, *this will dereference it
	p_dAbschnittStrecke += p_dGefahreneStrecke; //will equal to 0 when there are changes of weg (in the future)
